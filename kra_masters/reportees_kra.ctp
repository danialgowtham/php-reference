...
<div class="container">
    <div class="slim-pageheader">
        <ol class="breadcrumb slim-breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Reportees KRA</li>
        </ol>
        <h6 class="slim-pagetitle">Reportees KRA</h6>
    </div>
   <div class="section-wrapper">
        <div class="report-summary-header mg-b-5 mg-t-0">
            <div class="back_button">
                <div><label class="section-title">Choose your reportees to review KRA.</label></div>
            </div>
                <div>
...
<!--<button id="toggle">Show underlying select</button>-->
                ...
                <div class="col-lg-4">
                    <div class="form-group mg-b-10-force">
                        <label class="form-control-label ">Toggle To Filter Reportees</label>
                        <!--<input type='checkbox' class="toggle  success mg-t-10">-->
                        <div class="back_button" style=" justify-content:flex-start">
                            <div class="toggle toggle-light col-lg-3 success mg-t-10 pd-l-0" >
                            </div>
                            <div><label class="form-control-label tx-primary mg-t-15" id="filter_type">Waiting For Review </label></div>
                        </div>
                    </div>
                </div>
<!--                <div class="col-lg-2">
